...
class Knot(object):
    ...
    def __init__(self, name='default', **kwargs):
        ...
        if self._knot_name in config.sections():
            ...
            config.set(self._knot_name, 'jobs', '')
